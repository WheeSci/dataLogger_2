//digiPot tab:   / Copied from StellarisWheeStat5_3 sketch
...
void  setupDigiPot()  {             
 ...
 altSPI.setModule(0);
  ...
  altSPI.trans2ByteA(0);   // command 0; write to pot 0
  altSPI.trans2ByteB(gB);   //smaller number for gB amplifies?

  altSPI.trans2ByteA(16);   // command 16; write to pot 1
  altSPI.trans2ByteB(gainA);  //larger number amplifies
}
